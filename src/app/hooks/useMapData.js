...
export const useMapData = (filteredData, searchLat, searchLng, isSearchCleared, calculateDistance) => {
  ...
  useEffect(() => {
    setFilteredMapBoxData({ type: 'FeatureCollection', features: filteredData });
  }, [filteredData]);
