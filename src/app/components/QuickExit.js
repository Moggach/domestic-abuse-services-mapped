...
const QuickExit = () => {
   ...
   return (
      <button className="btn fixed w-full bottom-0 md:max-h-24  md:absolute  md:right-2 md:max-w-fit md:top-1/2 z-10 bg-green-600 text-white" onClick={handleClick}>
         Safe exit
